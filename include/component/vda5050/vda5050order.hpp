...
inline vda5050::order::ActionType
get_vda5050_type_from_str(const std::string &t) {
...
public:
  ...
  Edge() : sequence_id(0), released(false) {}
...
public:
  ...
  Node() : sequence_id(0), released(false) {}
...
public:
  ...
  VDA5050Order() : header_id(0), order_update_id(0) {}
