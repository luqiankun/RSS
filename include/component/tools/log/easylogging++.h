...
class File : base::StaticClass {
 public:
  ...
  static void buildBaseFilename(
      const std::string& fullPath, char buff[],
      std::size_t limit = base::consts::kSourceFilenameMaxLength,
      const char* separator = base::consts::kFilePathSeparator);
};
...
class OS : base::StaticClass {
 public:
  ...
  static std::string getEnvironmentVariable(
      const char* variableName, const char* defaultVal,
...
class DateTime : base::StaticClass {
 public:
  ...
  static std::string timevalToString(
  ...
  /// timestampUnit
  static unsigned long long getTimeDifference(
...
class Loggable {
 ...
 private:
  friend inline el::base::type::ostream_t& operator<<(
      el::base::type::ostream_t& os, const Loggable& loggable) {
    loggable.log(os);
    return os;
  }
};
...
class TypedConfigurations : public base::threading::ThreadSafe {
 public:
  ...
  const base::SubsecondPrecision& subsecondPrecision(
 ...
 private:
  ...
  inline bool validateFileRolling(
...
class Logger : public base::threading::ThreadSafe, public Loggable {
 public:
  ...
  inline void setParentApplicationName(
...
#define ELPP_SIMPLE_LOG(LOG_TYPE)                  \
  ...
  inline MessageBuilder& operator<<(
      std::ostream& (*OStreamMani)(std::ostream&)) {
...
void Logger::log_(Level level, int vlevel, const char* s, const T& value,
  ...
  ELPP_INTERNAL_ERROR(
      "Too many arguments provided. Unable to handle. Please provide more "
      "format specifiers",
      false);
}
template <typename T>
...
class PerformanceTracker : public base::threading::ThreadSafe, public Loggable {
 ...
 private:
  ...
  const base::type::string_t getFormattedTimeTaken(
...
inline const struct timeval* PerformanceTrackingData::lastCheckpointTime()
    const {
...
class Helpers : base::StaticClass {
 public:
  ...
  static inline void setCrashHandler(
  ...
  static void logCrashReason(
      int sig, bool stackTraceIfAvailable = false, Level level = Level::Fatal,
  ...
  static inline void installPreRollOutCallback(
  ...
  template <typename T>
  static inline void uninstallPerformanceTrackingCallback(
      const std::string& id) {
...
class Loggers : base::StaticClass {
 public:
  ...
  /// @brief Uninstalls log dispatch callback
  template <typename T>
  static inline void uninstallLoggerRegistrationCallback(
      const std::string& id) {
  ...
  static std::vector<std::string>* populateAllLoggerIds(
