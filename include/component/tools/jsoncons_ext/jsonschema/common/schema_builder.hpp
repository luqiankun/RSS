...
struct subschema_registry {
  ...
  std::vector<std::pair<std::string, ref_validator_type*>>
...
class schema_builder {
 public:
  ...
  virtual void build_schema(const Json& sch,
                            const std::string& retrieval_uri) = 0;
  ...
  virtual schema_validator_type make_schema_validator(
      ...
      jsoncons::span<const std::string> keys) = 0;
  ...
  virtual std::unique_ptr<max_length_validator<Json>> make_max_length_validator(
    ...
    return jsoncons::make_unique<max_length_validator<Json>>(schema_path,
                                                             value);
  }
  ...
  virtual std::unique_ptr<min_length_validator<Json>> make_min_length_validator(
    ...
    auto value = sch.template as<std::size_t>();
    return jsoncons::make_unique<min_length_validator<Json>>(schema_path,
                                                             value);
  }
  ...
  virtual std::unique_ptr<not_validator<Json>> make_not_validator(
    ...
    return jsoncons::make_unique<not_validator<Json>>(
        schema_path, make_schema_validator(context, sch, not_key));
  }
  ...
  virtual std::unique_ptr<required_validator<Json>> make_required_validator(
    ...
    return jsoncons::make_unique<required_validator<Json>>(
        schema_path, sch.template as<std::vector<std::string>>());
  }
  ...
  make_exclusive_maximum_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<exclusive_maximum_validator<Json>>(schema_path,
                                                                    sch);
  }
  ...
  make_exclusive_minimum_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<exclusive_minimum_validator<Json>>(schema_path,
                                                                    sch);
  }
  ...
  make_multiple_of_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<multiple_of_validator<Json>>(schema_path,
                                                              value);
  }
  ...
  virtual std::unique_ptr<type_validator<Json>> make_type_validator(
    ...
    return jsoncons::make_unique<type_validator<Json>>(
        std::move(schema_path), std::move(expected_types));
  }
  ...
  make_content_encoding_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<content_encoding_validator<Json>>(schema_path,
                                                                   value);
  }
  ...
  virtual std::unique_ptr<pattern_validator<Json>> make_pattern_validator(
    ...
    return jsoncons::make_unique<pattern_validator<Json>>(
        schema_path, pattern_string, regex);
  }
  ...
  virtual std::unique_ptr<contains_validator<Json>> make_contains_validator(
    ...
    if (it != parent.object_range().end()) {
      ...
      max_contains =
          jsoncons::make_unique<max_contains_keyword<Json>>(path, value);
    } else {
      uri path = context.make_schema_path_with("maxContains");
    ...
    if (it != parent.object_range().end()) {
      ...
      auto value = it->value().template as<std::size_t>();
      min_contains =
          jsoncons::make_unique<min_contains_keyword<Json>>(path, value);
    } else {
      uri path = context.make_schema_path_with("minContains");
  ...
  make_unique_items_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<unique_items_validator<Json>>(schema_path,
                                                               are_unique);
  }

  virtual std::unique_ptr<combining_validator<Json, all_of_criterion<Json>>>
  make_all_of_validator(const compilation_context& context, const Json& sch) {
    ...
    for (const auto& subsch : sch.array_range()) {
      std::string sub_keys[] = {all_of_criterion<Json>::key(),
                                std::to_string(c++)};
      subschemas.emplace_back(make_schema_validator(context, subsch, sub_keys));
    }
    return jsoncons::make_unique<
        combining_validator<Json, all_of_criterion<Json>>>(
        std::move(schema_path), std::move(subschemas));
  }

  virtual std::unique_ptr<combining_validator<Json, any_of_criterion<Json>>>
  make_any_of_validator(const compilation_context& context, const Json& sch) {
    uri schema_path = context.make_schema_path_with("anyOf");
    std::vector<schema_validator_type> subschemas;

    size_t c = 0;
    for (const auto& subsch : sch.array_range()) {
      std::string sub_keys[] = {any_of_criterion<Json>::key(),
                                std::to_string(c++)};
      subschemas.emplace_back(make_schema_validator(context, subsch, sub_keys));
    }
    return jsoncons::make_unique<
        combining_validator<Json, any_of_criterion<Json>>>(
        std::move(schema_path), std::move(subschemas));
  }

  virtual std::unique_ptr<combining_validator<Json, one_of_criterion<Json>>>
  make_one_of_validator(const compilation_context& context, const Json& sch) {
    uri schema_path{context.make_schema_path_with("oneOf")};
    std::vector<schema_validator_type> subschemas;

    size_t c = 0;
    for (const auto& subsch : sch.array_range()) {
      std::string sub_keys[] = {one_of_criterion<Json>::key(),
                                std::to_string(c++)};
      subschemas.emplace_back(make_schema_validator(context, subsch, sub_keys));
    }
    return jsoncons::make_unique<
        combining_validator<Json, one_of_criterion<Json>>>(
        std::move(schema_path), std::move(subschemas));
  }
  ...
  make_dependencies_validator(const compilation_context& context,
      ...
      switch (dep.value().type()) {
        case json_type::array_value: {
          ...
          dependent_required.emplace(
              dep.key(),
              this->make_required_validator(
                  compilation_context(std::vector<schema_identifier>{
                      {schema_identifier{location}}}),
        ...
        case json_type::object_value: {
          ...
          dependent_schemas.emplace(
              dep.key(), make_schema_validator(context, dep.value(), sub_keys));
          break;
        }
        default: {
          break;
    ...
    return jsoncons::make_unique<dependencies_validator<Json>>(
        std::move(schema_path), std::move(dependent_required),
  ...
  make_property_names_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<property_names_validator<Json>>(
        std::move(schema_path), std::move(property_names_schema_validator));
  }
  ...
  make_dependent_schemas_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<dependent_schemas_validator<Json>>(
        std::move(schema_path), std::move(dependent_schemas));
  }
  ...
  make_unevaluated_properties_validator(const compilation_context& context,
    ...
    return jsoncons::make_unique<unevaluated_properties_validator<Json>>(
        std::move(schema_path), make_schema_validator(context, sch, sub_keys));
  }
};
