...
#include "./detail/heap_string.hpp"
...
using container_array_iterator_type_t =
    decltype(Container::array_iterator_type);
template <typename Container>
using container_const_array_iterator_type_t =
    decltype(Container::const_array_iterator_type);
template <typename Container>
using container_object_iterator_type_t =
    decltype(Container::object_iterator_type);
template <typename Container>
using container_const_object_iterator_type_t =
    decltype(Container::const_object_iterator_type);

namespace detail {

template <typename T>
using basic_json_t = basic_json<typename T::char_type, typename T::policy_type,
...
struct is_basic_json<
    T, typename std::enable_if<extension_traits::is_detected<
           detail::basic_json_t, typename std::decay<T>::type>::value>::type>
    : std::true_type {};
...
class random_access_iterator_wrapper<
    Iterator, typename std::enable_if<std::is_same<
 ...
 public:
  ...
  explicit random_access_iterator_wrapper(Iterator ptr)
      : it_(ptr), has_value_(true) {}

  random_access_iterator_wrapper(const random_access_iterator_wrapper&) =
      default;
  ...
  random_access_iterator_wrapper& operator=(random_access_iterator_wrapper&&) =
      default;
  ...
  random_access_iterator_wrapper(
      const random_access_iterator_wrapper<Iter>& other)
      : it_(other.it_), has_value_(other.has_value_) {}

  operator Iterator() const { return it_; }
  ...
  difference_type operator-(
      const random_access_iterator_wrapper& rhs) const noexcept {
    return it_ - rhs.it_;
  }
  ...
  inline friend random_access_iterator_wrapper<Iterator> operator+(
...
struct object_iterator_typedefs<
    ...
    typename std::enable_if<
        !extension_traits::is_detected<
            extension_traits::container_object_iterator_type_t,
            Policy>::value ||
        !extension_traits::is_detected<
            extension_traits::container_const_object_iterator_type_t,
            Policy>::value>::type> {
  using object_iterator_type = jsoncons::detail::random_access_iterator_wrapper<
      typename Policy::template object<KeyT, Json>::iterator>;
  using const_object_iterator_type =
      jsoncons::detail::random_access_iterator_wrapper<
          typename Policy::template object<KeyT, Json>::const_iterator>;
};
...
struct object_iterator_typedefs<
    ...
    typename std::enable_if<
        ...
        extension_traits::is_detected<
            ...
            Policy>::value>::type> {
  using object_iterator_type = jsoncons::detail::random_access_iterator_wrapper<
      typename Policy::template object_iterator<KeyT, Json>>;
  using const_object_iterator_type =
      jsoncons::detail::random_access_iterator_wrapper<
          typename Policy::template const_object_iterator<KeyT, Json>>;
};
...
struct array_iterator_typedefs<
    ...
    typename std::enable_if<
        !extension_traits::is_detected<
            extension_traits::container_array_iterator_type_t, Policy>::value ||
        !extension_traits::is_detected<
            extension_traits::container_const_array_iterator_type_t,
            Policy>::value>::type> {
  using array_iterator_type = typename Policy::template array<Json>::iterator;
  using const_array_iterator_type =
      typename Policy::template array<Json>::const_iterator;
};
...
struct array_iterator_typedefs<
  ...
  using array_iterator_type =
      typename Policy::template array_iterator_type<Json>;
  using const_array_iterator_type =
      typename Policy::template const_array_iterator_type<Json>;
};
...
struct is_proxy_of<Proxy, Json,
                   typename std::enable_if<std::is_same<
                       typename Proxy::proxied_type, Json>::value>::type>
    : std::true_type {};
...
template <typename T>
struct is_proxy<T, typename std::enable_if<
                       is_proxy_of<T, typename T::proxied_type>::value>::type>
    : std::true_type {};
...
class basic_json {
 public:
  static_assert(
      extension_traits::is_stateless<Allocator>::value ||
          extension_traits::is_propagating_allocator<Allocator>::value,
      "Regular stateful allocators must be wrapped with "
  ...
  using string_view_type =
      jsoncons::basic_string_view<char_type, char_traits_type>;

  using char_allocator_type = typename std::allocator_traits<
      allocator_type>::template rebind_alloc<char_type>;

  using string_type =
      std::basic_string<char_type, char_traits_type, char_allocator_type>;

  using key_type =
      typename policy_type::template member_key<char_type, char_traits_type,
                                                char_allocator_type>;
  ...
  using key_value_allocator_type = typename std::allocator_traits<
      allocator_type>::template rebind_alloc<key_value_type>;

  using object = typename policy_type::template object<key_type, basic_json>;

  using object_iterator =
      typename object_iterator_typedefs<policy_type, key_type,
                                        basic_json>::object_iterator_type;
  using const_object_iterator =
      typename object_iterator_typedefs<policy_type, key_type,
                                        basic_json>::const_object_iterator_type;
  using array_iterator =
      typename array_iterator_typedefs<policy_type, key_type,
                                       basic_json>::array_iterator_type;
  using const_array_iterator =
      typename array_iterator_typedefs<policy_type, key_type,
                                       basic_json>::const_array_iterator_type;

  using object_range_type = range<object_iterator, const_object_iterator>;
  using const_object_range_type =
      range<const_object_iterator, const_object_iterator>;
  using array_range_type = range<array_iterator, const_array_iterator>;
  using const_array_range_type =
      range<const_array_iterator, const_array_iterator>;
 ...
 public:
  ...
  class null_storage final {
   public:
    ...
    null_storage(semantic_tag tag = semantic_tag::none)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::null)),
          short_str_length_(0),
          tag_(tag) {}
  };
  ...
  class empty_object_storage final {
   public:
    ...
    empty_object_storage(semantic_tag tag)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::empty_object)),
          short_str_length_(0),
          tag_(tag) {}
  };
  ...
  class bool_storage final {
   ...
   public:
    bool_storage(bool val, semantic_tag tag)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::boolean)),
          short_str_length_(0),
          tag_(tag),
          val_(val) {}
  ...
  class int64_storage final {
   ...
   public:
    int64_storage(int64_t val, semantic_tag tag = semantic_tag::none)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::int64)),
          short_str_length_(0),
          tag_(tag),
          val_(val) {}
  ...
  class uint64_storage final {
   ...
   public:
    uint64_storage(uint64_t val, semantic_tag tag = semantic_tag::none)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::uint64)),
          short_str_length_(0),
          tag_(tag),
          val_(val) {}
  ...
  class half_storage final {
   ...
   public:
    half_storage(uint16_t val, semantic_tag tag = semantic_tag::none)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::half_float)),
          short_str_length_(0),
          tag_(tag),
          val_(val) {}
  ...
  class double_storage final {
   ...
   public:
    double_storage(double val, semantic_tag tag = semantic_tag::none)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::float64)),
          short_str_length_(0),
          tag_(tag),
          val_(val) {}
  ...
  class short_string_storage final {
   ...
   private:
    static constexpr size_t capacity =
        (2 * sizeof(uint64_t) - 2 * sizeof(uint8_t)) / sizeof(char_type);
   ...
   public:
    ...
    short_string_storage(semantic_tag tag, const char_type* p, uint8_t length)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::short_str)),
  ...
  class long_string_storage final {
   ...
   private:
    using heap_string_factory_type =
        jsoncons::detail::heap_string_factory<char_type, null_type, Allocator>;
    using pointer = typename heap_string_factory_type::pointer;

    pointer ptr_;

   public:
    long_string_storage(semantic_tag tag, const char_type* data,
                        std::size_t length, const Allocator& alloc)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::long_str)),
          short_str_length_(0),
          tag_(tag) {
    ...
    long_string_storage(const long_string_storage& other)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::long_str)),
          short_str_length_(0),
          tag_(other.tag_) {
      ptr_ = heap_string_factory_type::create(
          other.data(), other.length(), null_type(), other.get_allocator());
    }
    ...
    long_string_storage(const long_string_storage& other,
        ...
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::long_str)),
          short_str_length_(0),
          tag_(other.tag_) {
      ptr_ = heap_string_factory_type::create(other.data(), other.length(),
                                              null_type(), alloc);
    }
    ...
    void assign(long_string_storage&& other) { swap(other); }

    ~long_string_storage() noexcept { heap_string_factory_type::destroy(ptr_); }
    ...
    semantic_tag tag() const { return tag_; }

    const char_type* data() const { return ptr_->data(); }

    const char_type* c_str() const { return ptr_->c_str(); }

    std::size_t length() const { return ptr_->length(); }

    allocator_type get_allocator() const { return ptr_->get_allocator(); }
  };
  ...
  class byte_string_storage final {
   ...
   private:
    using heap_string_factory_type =
        jsoncons::detail::heap_string_factory<uint8_t, uint64_t, Allocator>;
    using pointer = typename heap_string_factory_type::pointer;

    pointer ptr_;

   public:
    byte_string_storage(semantic_tag tag, const uint8_t* data,
                        std::size_t length, uint64_t ext_tag,
                        const Allocator& alloc)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::byte_str)),
          short_str_length_(0),
          tag_(tag) {
    ...
    byte_string_storage(const byte_string_storage& other)
        : storage_kind_(other.storage_kind_),
          ...
          tag_(other.tag_) {
      ptr_ = heap_string_factory_type::create(
          other.data(), other.length(), other.ext_tag(), other.get_allocator());
    }
    ...
    void assign(byte_string_storage&& other) { swap(other); }

    ~byte_string_storage() noexcept { heap_string_factory_type::destroy(ptr_); }
    ...
    uint64_t ext_tag() const { return ptr_->extra(); }
...
#pragma GCC diagnostic ignored "-Wmaybe-uninitialized"
  ...
  class array_storage final {
   ...
   private:
    ...
    void create(array_allocator alloc, Args&&... args) {
      ...
      JSONCONS_TRY {
        std::allocator_traits<array_allocator>::construct(
            alloc, extension_traits::to_plain_pointer(ptr_),
    ...
    void destroy() noexcept {
      ...
      std::allocator_traits<array_allocator>::destroy(
          alloc, extension_traits::to_plain_pointer(ptr_));
      std::allocator_traits<array_allocator>::deallocate(alloc, ptr_, 1);
    }
   ...
   public:
    array_storage(const array& val, semantic_tag tag)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::array)),
          short_str_length_(0),
          tag_(tag),
          ptr_(nullptr) {
    ...
    void assign(array_storage&& other) { swap(other); }
    ...
    array& value() { return *ptr_; }

    const array& value() const { return *ptr_; }
  };
  ...
  class object_storage final {
   ...
   private:
    using object_allocator = typename std::allocator_traits<
        Allocator>::template rebind_alloc<object>;
    ...
    void create(object_allocator alloc, Args&&... args) {
      ...
      JSONCONS_TRY {
        std::allocator_traits<object_allocator>::construct(
            alloc, extension_traits::to_plain_pointer(ptr_),
            std::forward<Args>(args)...);
      }
      JSONCONS_CATCH(...) {
   ...
   public:
    object_storage(const object& val, semantic_tag tag)
        : storage_kind_(static_cast<uint8_t>(json_storage_kind::object)),
          short_str_length_(0),
          tag_(tag),
          ptr_(nullptr) {
      create(val.get_allocator(), val);
    ...
    void assign(object_storage&& other) { swap(other); }
   ...
   private:
    void destroy() noexcept {
      ...
      std::allocator_traits<object_allocator>::destroy(
          alloc, extension_traits::to_plain_pointer(ptr_));
      std::allocator_traits<object_allocator>::deallocate(alloc, ptr_, 1);
    }
  };
...
#pragma GCC diagnostic pop
 ...
 private:
  class json_const_pointer_storage final {
   ...
   public:
    json_const_pointer_storage(const basic_json* p)
        : storage_kind_(
              static_cast<uint8_t>(json_storage_kind::const_json_pointer)),
          short_str_length_(0),
          tag_(p->tag()),
          p_(p) {}

    const basic_json* value() const { return p_; }
  };
  ...
  class proxy {
    ...
    basic_json& evaluate(std::size_t index) { return evaluate().at(index); }
   ...
   public:
    ...
    basic_json& evaluate() { return parent_.evaluate(key_); }

    const basic_json& evaluate() const { return parent_.evaluate(key_); }

    operator basic_json&() { return evaluate(); }

    operator const basic_json&() const { return evaluate(); }

    object_range_type object_range() { return evaluate().object_range(); }

    const_object_range_type object_range() const {
      return evaluate().object_range();
    }

    array_range_type array_range() { return evaluate().array_range(); }
    ...
    json_storage_kind storage_kind() const { return evaluate().storage_kind(); }

    semantic_tag tag() const { return evaluate().tag(); }

    json_type type() const { return evaluate().type(); }

    std::size_t count(const string_view_type& name) const {
      return evaluate().count(name);
    }

    allocator_type get_allocator() const { return evaluate().get_allocator(); }

    uint64_t ext_tag() const { return evaluate().ext_tag(); }
    ...
    std::size_t capacity() const { return evaluate().capacity(); }

    void reserve(std::size_t n) { evaluate().reserve(n); }

    void resize(std::size_t n) { evaluate().resize(n); }
    ...
    std::basic_string<char_type, char_traits_type, SAllocator> as_string()
        const {
    ...
    template <typename T>
    typename std::enable_if<
        is_json_type_traits_specialized<basic_json, T>::value, T>::type
    as() const {
    ...
    template <typename T>
    typename std::enable_if<
        std::is_convertible<uint8_t, typename T::value_type>::value, T>::type
    as(byte_string_arg_t, semantic_tag hint) const {
      return evaluate().template as<T>(byte_string_arg, hint);
    }

    bool as_bool() const { return evaluate().as_bool(); }

    double as_double() const { return evaluate().as_double(); }
    ...
    proxy& operator=(T&& val) {
      parent_.evaluate_with_default().insert_or_assign(key_,
                                                       std::forward<T>(val));
      return *this;
    }
    ...
    basic_json& at(const string_view_type& name) { return evaluate().at(name); }
    ...
    const basic_json& at(std::size_t index) { return evaluate().at(index); }
    ...
    T get_value_or(const string_view_type& name, U&& default_value) const {
      ...
      return evaluate().template get_value_or<T, U>(
          name, std::forward<U>(default_value));
    }

    void shrink_to_fit() { evaluate_with_default().shrink_to_fit(); }

    void clear() { evaluate().clear(); }
    ...
    object_iterator erase(const_object_iterator first,
                          const_object_iterator last) {
      return evaluate().erase(first, last);
    }
    // Remove a range of elements from an object

    void erase(const string_view_type& name) { evaluate().erase(name); }
    ...
    array_iterator erase(const_array_iterator first,
    ...
    void merge(const basic_json& source) { return evaluate().merge(source); }
    ...
    template <typename T>
    std::pair<object_iterator, bool> insert_or_assign(
        const string_view_type& name, T&& val) {
    ...
    template <typename... Args>
    std::pair<object_iterator, bool> try_emplace(const string_view_type& name,
                                                 Args&&... args) {
      return evaluate().try_emplace(name, std::forward<Args>(args)...);
    }

    template <typename T>
    object_iterator insert_or_assign(object_iterator hint,
                                     const string_view_type& name, T&& val) {
      return evaluate().insert_or_assign(hint, name, std::forward<T>(val));
    }

    template <typename... Args>
    object_iterator try_emplace(object_iterator hint,
                                const string_view_type& name, Args&&... args) {
    ...
    array_iterator insert(const_array_iterator pos, InputIt first,
                          InputIt last) {
    ...
    void swap(basic_json& other) { evaluate_with_default().swap(other); }

    friend std::basic_ostream<char_type>& operator<<(
        std::basic_ostream<char_type>& os, const proxy& o) {
      o.dump(os);
      return os;
    }
 ...
 private:
  null_storage& cast(identity<null_storage>) { return null_stor_; }

  const null_storage& cast(identity<null_storage>) const { return null_stor_; }
  ...
  bool_storage& cast(identity<bool_storage>) { return bool_stor_; }

  const bool_storage& cast(identity<bool_storage>) const { return bool_stor_; }

  int64_storage& cast(identity<int64_storage>) { return int64_stor_; }

  const int64_storage& cast(identity<int64_storage>) const {
    return int64_stor_;
  }

  uint64_storage& cast(identity<uint64_storage>) { return uint64_stor_; }

  const uint64_storage& cast(identity<uint64_storage>) const {
    return uint64_stor_;
  }

  half_storage& cast(identity<half_storage>) { return half_stor_; }

  const half_storage& cast(identity<half_storage>) const { return half_stor_; }

  double_storage& cast(identity<double_storage>) { return double_stor_; }
  ...
  object_storage& cast(identity<object_storage>) { return object_stor_; }

  const object_storage& cast(identity<object_storage>) const {
    return object_stor_;
  }

  array_storage& cast(identity<array_storage>) { return array_stor_; }
  ...
  const json_const_pointer_storage& cast(
      identity<json_const_pointer_storage>) const {
    return json_const_pointer_stor_;
  }
  ...
  void swap_l_r(identity<long_string_storage>, identity<long_string_storage>,
                basic_json& other) {
    cast<long_string_storage>().swap(other.cast<long_string_storage>());
  }

  void swap_l_r(identity<byte_string_storage>, identity<byte_string_storage>,
                basic_json& other) {
    cast<byte_string_storage>().swap(other.cast<byte_string_storage>());
  }

  void swap_l_r(identity<array_storage>, identity<array_storage>,
                basic_json& other) {
    cast<array_storage>().swap(other.cast<array_storage>());
  }

  void swap_l_r(identity<object_storage>, identity<object_storage>,
                basic_json& other) {
  ...
  void swap_l(basic_json& other) {
    switch (other.storage_kind()) {
      case json_storage_kind::null:
        swap_l_r<TypeL, null_storage>(other);
        break;
      case json_storage_kind::empty_object:
        swap_l_r<TypeL, empty_object_storage>(other);
        break;
      case json_storage_kind::boolean:
        swap_l_r<TypeL, bool_storage>(other);
        break;
      case json_storage_kind::int64:
        swap_l_r<TypeL, int64_storage>(other);
        break;
      case json_storage_kind::uint64:
        swap_l_r<TypeL, uint64_storage>(other);
        break;
      case json_storage_kind::half_float:
        swap_l_r<TypeL, half_storage>(other);
        break;
      case json_storage_kind::float64:
        swap_l_r<TypeL, double_storage>(other);
        break;
      case json_storage_kind::short_str:
        swap_l_r<TypeL, short_string_storage>(other);
        break;
      case json_storage_kind::long_str:
        swap_l_r<TypeL, long_string_storage>(other);
        break;
      case json_storage_kind::byte_str:
        swap_l_r<TypeL, byte_string_storage>(other);
        break;
      case json_storage_kind::array:
        swap_l_r<TypeL, array_storage>(other);
        break;
      case json_storage_kind::object:
        swap_l_r<TypeL, object_storage>(other);
        break;
      case json_storage_kind::const_json_pointer:
        swap_l_r<TypeL, json_const_pointer_storage>(other);
        break;
      default:
  ...
  void uninitialized_move(basic_json&& other) noexcept {
    if (is_scalar_storage(other.storage_kind())) {
      ...
      switch (other.storage_kind()) {
        case json_storage_kind::long_str:
          construct<long_string_storage>(
              std::move(other.cast<long_string_storage>()));
          break;
        case json_storage_kind::byte_str:
          construct<byte_string_storage>(
              std::move(other.cast<byte_string_storage>()));
          break;
        case json_storage_kind::array:
  ...
  void uninitialized_move_a(std::false_type /* stateful allocator */,
    ...
    if (is_scalar_storage(other.storage_kind())) {
      ...
      switch (other.storage_kind()) {
        case json_storage_kind::long_str:
          construct<long_string_storage>(
              std::move(other.cast<long_string_storage>()), alloc);
          break;
        case json_storage_kind::byte_str:
          construct<byte_string_storage>(
              std::move(other.cast<byte_string_storage>()), alloc);
          break;
        case json_storage_kind::array:
          construct<array_storage>(std::move(other.cast<array_storage>()),
                                   alloc);
      ...
      switch (other.storage_kind()) {
        case json_storage_kind::long_str:
          if (storage_kind() == json_storage_kind::long_str) {
            cast<long_string_storage>().assign(
                other.cast<long_string_storage>());
          } else {
            destroy();
        ...
        case json_storage_kind::byte_str:
          if (storage_kind() == json_storage_kind::byte_str) {
            cast<byte_string_storage>().assign(
                other.cast<byte_string_storage>());
          } else {
            destroy();
            uninitialized_copy(other);
          }
  ...
  void move_assignment(basic_json&& other) {
    if (is_scalar_storage(other.storage_kind())) {
      ...
      switch (other.storage_kind()) {
        ...
        case json_storage_kind::array:
          if (storage_kind() == json_storage_kind::array) {
            cast<array_storage>().assign(
                std::move(other.cast<array_storage>()));
          } else {
            destroy();
            uninitialized_move(std::move(other));
          }
        ...
        case json_storage_kind::object:
          if (storage_kind() == json_storage_kind::object) {
            cast<object_storage>().assign(
                std::move(other.cast<object_storage>()));
          } else {
            destroy();
            uninitialized_move(std::move(other));
          }
  ...
  basic_json& evaluate_with_default() { return *this; }

  basic_json& evaluate(const string_view_type& name) { return at(name); }
 ...
 public:
  basic_json& evaluate() { return *this; }

  const basic_json& evaluate() const { return *this; }
  ...
  json_storage_kind storage_kind() const {
    ...
    // common_stor_ is not the active member of the union because
    // 'storage_kind_' is a part of the common initial sequence of all union
    // members as defined in 11.4-25 of the Standard.
  ...
  string_view_type as_string_view() const {
    switch (storage_kind()) {
      case json_storage_kind::short_str:
        return string_view_type(cast<short_string_storage>().data(),
                                cast<short_string_storage>().length());
      case json_storage_kind::long_str:
        return string_view_type(cast<long_string_storage>().data(),
                                cast<long_string_storage>().length());
      case json_storage_kind::const_json_pointer:
  ...
  basic_byte_string<BAllocator> as_byte_string() const {
    ...
    switch (storage_kind()) {
      ...
      case json_storage_kind::byte_str:
        return basic_byte_string<BAllocator>(
            cast<byte_string_storage>().data(),
            cast<byte_string_storage>().length());
      case json_storage_kind::const_json_pointer:
        return cast<json_const_pointer_storage>().value()->as_byte_string();
      default:
        JSONCONS_THROW(
            json_runtime_error<std::domain_error>("Not a byte string"));
    }
  }
  ...
  byte_string_view as_byte_string_view() const {
    switch (storage_kind()) {
      case json_storage_kind::byte_str:
        return byte_string_view(cast<byte_string_storage>().data(),
                                cast<byte_string_storage>().length());
      case json_storage_kind::const_json_pointer:
        return cast<json_const_pointer_storage>()
            .value()
            ->as_byte_string_view();
      default:
        JSONCONS_THROW(
    ...
    switch (storage_kind()) {
      case json_storage_kind::const_json_pointer:
        switch (rhs.storage_kind()) {
          case json_storage_kind::const_json_pointer:
            return (cast<json_const_pointer_storage>().value())
                ->compare(*(rhs.cast<json_const_pointer_storage>().value()));
          default:
            return (cast<json_const_pointer_storage>().value())->compare(rhs);
        }
        break;
      case json_storage_kind::null:
        return static_cast<int>(storage_kind()) -
               static_cast<int>((int)rhs.storage_kind());
      case json_storage_kind::empty_object:
        switch (rhs.storage_kind()) {
          case json_storage_kind::empty_object:
            return 0;
      ...
      case json_storage_kind::boolean:
        switch (rhs.storage_kind()) {
          case json_storage_kind::boolean:
            return static_cast<int>(cast<bool_storage>().value()) -
                   static_cast<int>(rhs.cast<bool_storage>().value());
          case json_storage_kind::const_json_pointer:
            return compare(*(rhs.cast<json_const_pointer_storage>().value()));
          default:
            return static_cast<int>(storage_kind()) -
      ...
      case json_storage_kind::int64:
        switch (rhs.storage_kind()) {
          case json_storage_kind::int64: {
            if (cast<int64_storage>().value() ==
                rhs.cast<int64_storage>().value())
              return 0;
            return cast<int64_storage>().value() <
                           rhs.cast<int64_storage>().value()
                       ? -1
                       : 1;
          }
          case json_storage_kind::uint64:
            if (cast<int64_storage>().value() < 0)
              return -1;
            else if (static_cast<uint64_t>(cast<int64_storage>().value()) ==
                     rhs.cast<uint64_storage>().value())
              return 0;
            else
              return static_cast<uint64_t>(cast<int64_storage>().value()) <
                             rhs.cast<uint64_storage>().value()
                         ? -1
                         : 1;
          case json_storage_kind::float64: {
            double r = static_cast<double>(cast<int64_storage>().value()) -
                       rhs.cast<double_storage>().value();
        ...
        switch (rhs.storage_kind()) {
          case json_storage_kind::int64:
            if (rhs.cast<int64_storage>().value() < 0)
              return 1;
            else if (cast<uint64_storage>().value() ==
                     static_cast<uint64_t>(rhs.cast<int64_storage>().value()))
              return 0;
            else
              return cast<uint64_storage>().value() <
                             static_cast<uint64_t>(
                                 rhs.cast<int64_storage>().value())
                         ? -1
                         : 1;
          case json_storage_kind::uint64:
            if (cast<uint64_storage>().value() ==
                static_cast<uint64_t>(rhs.cast<int64_storage>().value()))
              return 0;
            else
              return cast<uint64_storage>().value() <
                         ...
                         : 1;
          case json_storage_kind::float64: {
            auto r = static_cast<double>(cast<uint64_storage>().value()) -
                     rhs.cast<double_storage>().value();
      ...
      case json_storage_kind::float64:
        switch (rhs.storage_kind()) {
          case json_storage_kind::int64: {
            auto r = cast<double_storage>().value() -
                     static_cast<double>(rhs.cast<int64_storage>().value());
            return r == 0 ? 0 : (r < 0.0 ? -1 : 1);
          }
          case json_storage_kind::uint64: {
            auto r = cast<double_storage>().value() -
                     static_cast<double>(rhs.cast<uint64_storage>().value());
            return r == 0 ? 0 : (r < 0.0 ? -1 : 1);
          }
          case json_storage_kind::float64: {
            auto r = cast<double_storage>().value() -
      ...
      case json_storage_kind::long_str:
        if (is_number_tag(tag())) {
          ...
          switch (rhs.storage_kind()) {
            case json_storage_kind::int64: {
              auto r =
                  val1 - static_cast<double>(rhs.cast<int64_storage>().value());
              return r == 0 ? 0 : (r < 0.0 ? -1 : 1);
            }
            case json_storage_kind::uint64: {
              auto r = val1 -
      ...
      case json_storage_kind::array:
        switch (rhs.storage_kind()) {
          case json_storage_kind::array: {
            if (cast<array_storage>().value() ==
                rhs.cast<array_storage>().value())
              return 0;
            else
      ...
      case json_storage_kind::object:
        switch (rhs.storage_kind()) {
          case json_storage_kind::empty_object:
            return empty() ? 0 : 1;
          case json_storage_kind::object: {
            if (cast<object_storage>().value() ==
                rhs.cast<object_storage>().value())
              return 0;
            else
  ...
  void swap(basic_json& other) noexcept {
    ...
    switch (storage_kind()) {
      case json_storage_kind::null:
        swap_l<null_storage>(other);
        break;
      case json_storage_kind::empty_object:
        swap_l<empty_object_storage>(other);
        break;
      case json_storage_kind::boolean:
        swap_l<bool_storage>(other);
        break;
      case json_storage_kind::int64:
        swap_l<int64_storage>(other);
        break;
      case json_storage_kind::uint64:
        swap_l<uint64_storage>(other);
        break;
      case json_storage_kind::half_float:
        swap_l<half_storage>(other);
        break;
      case json_storage_kind::float64:
        swap_l<double_storage>(other);
        break;
      case json_storage_kind::short_str:
        swap_l<short_string_storage>(other);
        break;
      case json_storage_kind::long_str:
        swap_l<long_string_storage>(other);
        break;
      case json_storage_kind::byte_str:
        swap_l<byte_string_storage>(other);
        break;
      case json_storage_kind::array:
        swap_l<array_storage>(other);
        break;
      case json_storage_kind::object:
        swap_l<object_storage>(other);
        break;
      case json_storage_kind::const_json_pointer:
        swap_l<json_const_pointer_storage>(other);
        break;
      default:
        JSONCONS_UNREACHABLE();
        break;
  ...
  parse(const Source& source,
    ...
    if (!decoder.is_valid()) {
      JSONCONS_THROW(
          ser_error(json_errc::source_error, "Failed to parse json string"));
    }
  ...
  static typename std::enable_if<
      extension_traits::is_sequence_of<Source, char_type>::value,
      basic_json>::type
  parse(const allocator_set<allocator_type, TempAllocator>& alloc_set,
        const Source& source,
        const basic_json_decode_options<char_type>& options =
            basic_json_options<char_type>()) {
    json_decoder<basic_json> decoder(alloc_set.get_allocator(),
                                     alloc_set.get_temp_allocator());
    basic_json_parser<char_type, TempAllocator> parser(
  ...
  static basic_json parse(
      const allocator_set<allocator_type, TempAllocator>& alloc_set,
      const char_type* source,
      const basic_json_decode_options<char_type>& options =
          basic_json_options<char_type>()) {
    return parse(alloc_set, jsoncons::basic_string_view<char_type>(source),
                 options);
  }
  ...
  static basic_json parse(
      ...
      const basic_json_decode_options<char_type>& options =
          basic_json_options<char_type>()) {
    return parse(alloc_set, jsoncons::basic_string_view<char_type>(str, length),
                 options);
  }
  ...
  static basic_json parse(std::basic_istream<char_type>& is,
    ...
    json_decoder<basic_json> decoder;
    basic_json_reader<char_type, stream_source<char_type>, Allocator> reader(
        is, decoder, options);
    reader.read_next();
    reader.check_done();
    if (!decoder.is_valid()) {
      JSONCONS_THROW(
          ser_error(json_errc::source_error, "Failed to parse json stream"));
    }
    return decoder.get_result();
  }
  ...
  static basic_json parse(
    ...
    json_decoder<basic_json> decoder(alloc_set.get_allocator(),
                                     alloc_set.get_temp_allocator());
    basic_json_reader<char_type, stream_source<char_type>, Allocator> reader(
        is, decoder, options, alloc_set.get_temp_allocator());
    reader.read_next();
    reader.check_done();
    if (!decoder.is_valid()) {
      JSONCONS_THROW(
  ...
  static basic_json parse(InputIt first, InputIt last,
                          const basic_json_decode_options<char_type>& options =
                              basic_json_options<CharT>()) {
    json_decoder<basic_json> decoder;
    basic_json_reader<char_type, iterator_source<InputIt>, Allocator> reader(
        iterator_source<InputIt>(std::forward<InputIt>(first),
                                 std::forward<InputIt>(last)),
        decoder, options);
    reader.read_next();
    reader.check_done();
    if (!decoder.is_valid()) {
      JSONCONS_THROW(ser_error(json_errc::source_error,
                               "Failed to parse json from iterator pair"));
    }
    return decoder.get_result();
  }
  ...
  static basic_json parse(
      const char_type* s, const basic_json_decode_options<char_type>& options,
      std::function<bool(json_errc, const ser_context&)> err_handler) {
    return parse(jsoncons::basic_string_view<char_type>(s), options,
                 err_handler);
  }
  ...
  static basic_json parse(
      const char_type* s,
      std::function<bool(json_errc, const ser_context&)> err_handler) {
    return parse(jsoncons::basic_string_view<char_type>(s),
  ...
  static basic_json parse(
      ...
      std::function<bool(json_errc, const ser_context&)> err_handler) {
    json_decoder<basic_json> decoder;
    basic_json_reader<char_type, stream_source<char_type>> reader(
        is, decoder, options, err_handler);
    reader.read_next();
    reader.check_done();
    if (!decoder.is_valid()) {
      JSONCONS_THROW(
  ...
  static basic_json parse(
      ...
      std::function<bool(json_errc, const ser_context&)> err_handler) {
    json_decoder<basic_json> decoder;
    basic_json_reader<char_type, iterator_source<InputIt>> reader(
        iterator_source<InputIt>(std::forward<InputIt>(first),
                                 std::forward<InputIt>(last)),
        decoder, options, err_handler);
    reader.read_next();
    reader.check_done();
    if (!decoder.is_valid()) {
      JSONCONS_THROW(ser_error(json_errc::source_error,
...
#endif
  static basic_json make_array() { return basic_json(array()); }

  static basic_json make_array(const array& alloc) { return basic_json(alloc); }

  static basic_json make_array(const array& a, allocator_type alloc) {
    return basic_json(a, semantic_tag::none, alloc);
  }

  static basic_json make_array(std::initializer_list<basic_json> init,
                               const Allocator& alloc = Allocator()) {
    return array(std::move(init), alloc);
  }

  static basic_json make_array(std::size_t n,
                               const Allocator& alloc = Allocator()) {
    return array(n, alloc);
  }

  template <typename T>
  static basic_json make_array(std::size_t n, const T& val,
                               const Allocator& alloc = Allocator()) {
    return basic_json::array(n, val, alloc);
  }

  template <std::size_t dim>
  static typename std::enable_if<dim == 1, basic_json>::type make_array(
      std::size_t n) {
    return array(n);
  }
  ...
  static typename std::enable_if<dim == 1, basic_json>::type make_array(
      std::size_t n, const T& val, const Allocator& alloc = Allocator()) {
    return array(n, val, alloc);
  }

  template <std::size_t dim, typename... Args>
  static typename std::enable_if<(dim > 1), basic_json>::type make_array(
      std::size_t n, Args... args) {
  ...
  static const basic_json& null() {
    static const basic_json a_null =
        basic_json(null_type(), semantic_tag::none);
    return a_null;
  }

  basic_json() { construct<empty_object_storage>(semantic_tag::none); }

  explicit basic_json(const Allocator&) {
    construct<empty_object_storage>(semantic_tag::none);
  }

  basic_json(semantic_tag tag) { construct<empty_object_storage>(tag); }

  basic_json(const basic_json& other) { uninitialized_copy(other); }
  ...
  basic_json(basic_json&& other, const Allocator& alloc) noexcept {
    uninitialized_move_a(extension_traits::is_stateless<U>{}, std::move(other),
                         alloc);
  }

  explicit basic_json(json_object_arg_t, semantic_tag tag,
                      const Allocator& alloc = Allocator()) {
  ...
  template <typename InputIt>
  basic_json(json_object_arg_t, InputIt first, InputIt last,
  ...
  basic_json(
      json_object_arg_t,
      std::initializer_list<std::pair<std::basic_string<char_type>, basic_json>>
          init,
      semantic_tag tag = semantic_tag::none,
      const Allocator& alloc = Allocator()) {
  ...
  explicit basic_json(json_array_arg_t, semantic_tag tag,
                      const Allocator& alloc = Allocator()) {
    construct<array_storage>(array(alloc), tag);
  }

  template <typename InputIt>
  basic_json(json_array_arg_t, InputIt first, InputIt last,
             semantic_tag tag = semantic_tag::none,
             const Allocator& alloc = Allocator()) {
    construct<array_storage>(array(first, last, alloc), tag);
  }

  basic_json(json_array_arg_t, std::initializer_list<basic_json> init,
             semantic_tag tag = semantic_tag::none,
             const Allocator& alloc = Allocator()) {
  ...
  template <typename T, class = typename std::enable_if<
                            !is_proxy_of<T, basic_json>::value &&
                            !extension_traits::is_basic_json<T>::value>::type>
  ...
  basic_json(const char_type* s, std::size_t length, semantic_tag tag,
             const Allocator& alloc) {
    if (length <= short_string_storage::max_length) {
      construct<short_string_storage>(tag, s, static_cast<uint8_t>(length));
    } else {
  ...
  basic_json(half_arg_t, uint16_t val, semantic_tag tag,
  ...
  basic_json(IntegerType val, semantic_tag tag,
             typename std::enable_if<
                 extension_traits::is_unsigned_integer<IntegerType>::value &&
  ...
  basic_json(IntegerType val, semantic_tag, Allocator alloc = Allocator(),
             typename std::enable_if<
                 extension_traits::is_unsigned_integer<IntegerType>::value &&
                     sizeof(uint64_t) < sizeof(IntegerType),
                 int>::type = 0) {
    std::basic_string<CharT> s;
    jsoncons::detail::from_integer(val, s);
    if (s.length() <= short_string_storage::max_length) {
      construct<short_string_storage>(semantic_tag::bigint, s.data(),
                                      static_cast<uint8_t>(s.length()));
    } else {
      construct<long_string_storage>(semantic_tag::bigint, s.data(), s.length(),
                                     alloc);
    }
  }
  ...
  basic_json(IntegerType val, semantic_tag tag,
             typename std::enable_if<
                 extension_traits::is_signed_integer<IntegerType>::value &&
                     sizeof(IntegerType) <= sizeof(int64_t),
                 int>::type = 0) {
  ...
  basic_json(IntegerType val, semantic_tag, Allocator alloc = Allocator(),
             typename std::enable_if<
                 extension_traits::is_signed_integer<IntegerType>::value &&
                     sizeof(int64_t) < sizeof(IntegerType),
                 int>::type = 0) {
    std::basic_string<CharT> s;
    jsoncons::detail::from_integer(val, s);
    if (s.length() <= short_string_storage::max_length) {
  ...
  basic_json(null_type, semantic_tag tag) { construct<null_storage>(tag); }

  basic_json(null_type, semantic_tag tag, const Allocator&) {
    construct<null_storage>(tag);
  }

  basic_json(bool val, semantic_tag tag) { construct<bool_storage>(val, tag); }
  ...
  template <typename Source>
  basic_json(
      byte_string_arg_t, const Source& source,
      semantic_tag tag = semantic_tag::none,
      const Allocator& alloc = Allocator(),
      typename std::enable_if<extension_traits::is_byte_sequence<Source>::value,
                              int>::type = 0) {
    auto bytes = jsoncons::span<const uint8_t>(
  ...
  template <typename Source>
  basic_json(
      byte_string_arg_t, const Source& source, uint64_t ext_tag,
      const Allocator& alloc = Allocator(),
      typename std::enable_if<extension_traits::is_byte_sequence<Source>::value,
                              int>::type = 0) {
    auto bytes = jsoncons::span<const uint8_t>(
        reinterpret_cast<const uint8_t*>(source.data()), source.size());
    construct<byte_string_storage>(semantic_tag::ext, bytes.data(),
                                   bytes.size(), ext_tag, alloc);
  }

  ~basic_json() noexcept { destroy(); }
  ...
  basic_json& operator[](std::size_t i) { return at(i); }

  const basic_json& operator[](std::size_t i) const { return at(i); }
  ...
  typename std::enable_if<extension_traits::is_back_insertable_char_container<
  ...
  dump_pretty(CharContainer& cont,
              const basic_json_encode_options<char_type>& options =
                  basic_json_options<CharT>()) const {
    std::error_code ec;
  ...
  dump_pretty(CharContainer& cont,
    ...
    basic_json_encoder<char_type, jsoncons::string_sink<CharContainer>> encoder(
        cont, options);
    dump(encoder, ec);
  }
  ...
  typename std::enable_if<extension_traits::is_back_insertable_char_container<
      CharContainer>::value>::type
  dump_pretty(CharContainer& cont, std::error_code& ec) const {
  ...
  typename std::enable_if<extension_traits::is_back_insertable_char_container<
      CharContainer>::value>::type
  dump(CharContainer& cont, const basic_json_encode_options<char_type>& options,
       std::error_code& ec) const {
    basic_compact_json_encoder<char_type, jsoncons::string_sink<CharContainer>>
        encoder(cont, options);
    dump(encoder, ec);
  }
  ...
  void dump(std::basic_ostream<char_type>& os, std::error_code& ec) const {
  ...
  typename std::enable_if<extension_traits::is_back_insertable_char_container<
      CharContainer>::value>::type
  dump(CharContainer& cont, const basic_json_encode_options<char_type>& options,
       indenting indent, std::error_code& ec) const {
  ...
  typename std::enable_if<extension_traits::is_back_insertable_char_container<
      CharContainer>::value>::type
  dump(CharContainer& cont, indenting indent, std::error_code& ec) const {
    if (indent == indenting::indent) {
      dump_pretty(cont, ec);
    } else {
      dump(cont, ec);
  ...
  void dump(std::basic_ostream<char_type>& os, indenting indent,
            std::error_code& ec) const {
    if (indent == indenting::indent) {
      dump_pretty(os, ec);
    } else {
  ...
  void dump(basic_json_visitor<char_type>& visitor, std::error_code& ec) const {
  ...
  template <typename T, typename... Args>
  bool is(Args&&... args) const noexcept {
    return json_type_traits<basic_json, T>::is(*this,
                                               std::forward<Args>(args)...);
  }
  ...
  bool is_byte_string_view() const noexcept { return is_byte_string(); }

  bool is_bignum() const {
    switch (storage_kind()) {
      case json_storage_kind::short_str:
      case json_storage_kind::long_str:
        return jsoncons::detail::is_base10(as_string_view().data(),
                                           as_string_view().length());
      case json_storage_kind::int64:
      case json_storage_kind::uint64:
        return true;
      case json_storage_kind::const_json_pointer:
  ...
  bool is_number() const noexcept {
    switch (storage_kind()) {
      ...
      case json_storage_kind::short_str:
      case json_storage_kind::long_str:
        return tag() == semantic_tag::bigint || tag() == semantic_tag::bigdec ||
  ...
  void create_object_implicitly(std::false_type) {
    JSONCONS_THROW(json_runtime_error<std::domain_error>(
        "Cannot create object implicitly - allocator is stateful."));
  }
  ...
  template <typename T>
  typename std::enable_if<is_json_type_traits_specialized<basic_json, T>::value,
                          T>::type
  as() const {
  ...
  typename std::enable_if<
      (!extension_traits::is_string<T>::value &&
       extension_traits::is_back_insertable_byte_container<T>::value) ||
          extension_traits::is_basic_byte_string<T>::value,
      T>::type
  as(byte_string_arg_t, semantic_tag hint) const {
    std::error_code ec;
    switch (storage_kind()) {
      ...
      case json_storage_kind::long_str: {
        switch (tag()) {
          ...
          case semantic_tag::base64url: {
            value_converter<jsoncons::basic_string_view<char_type>, T>
                converter;
      ...
      case json_storage_kind::const_json_pointer:
        return cast<json_const_pointer_storage>().value()->template as<T>(
            byte_string_arg, hint);
      default:
        JSONCONS_THROW(
            json_runtime_error<std::domain_error>("Not a byte string"));
    }
  ...
  IntegerType as_integer() const {
    switch (storage_kind()) {
      ...
      case json_storage_kind::long_str: {
        IntegerType val;
        auto result = jsoncons::detail::to_integer(
            as_string_view().data(), as_string_view().length(), val);
        if (!result) {
          JSONCONS_THROW(json_runtime_error<std::runtime_error>(
      ...
      case json_storage_kind::const_json_pointer:
        return cast<json_const_pointer_storage>()
            .value()
            ->template as_integer<IntegerType>();
      default:
    ...
    switch (storage_kind()) {
      case json_storage_kind::int64:
        return (as_integer<int64_t>() >=
                (extension_traits::integer_limits<IntegerType>::lowest)()) &&
               (as_integer<int64_t>() <=
                (extension_traits::integer_limits<IntegerType>::max)());
      case json_storage_kind::uint64:
        return as_integer<uint64_t>() <=
               static_cast<uint64_t>(
                   (extension_traits::integer_limits<IntegerType>::max)());
      case json_storage_kind::const_json_pointer:
        return cast<json_const_pointer_storage>()
            .value()
            ->template is_integer<IntegerType>();
      default:
        return false;
    }
  }
  ...
  is_integer() const noexcept {
    switch (storage_kind()) {
      case json_storage_kind::int64:
        return as_integer<int64_t>() >= 0 &&
               static_cast<uint64_t>(as_integer<int64_t>()) <=
                   (extension_traits::integer_limits<IntegerType>::max)();
      case json_storage_kind::uint64:
        return as_integer<uint64_t>() <=
               (extension_traits::integer_limits<IntegerType>::max)();
  ...
  double as_double() const {
    switch (storage_kind()) {
      ...
      default:
        JSONCONS_THROW(
            json_runtime_error<std::invalid_argument>("Not a double"));
    }
  }
  ...
  std::basic_string<char_type, char_traits_type, SAllocator> as_string(
      const SAllocator& alloc) const {
    using string_type2 =
        std::basic_string<char_type, char_traits_type, SAllocator>;

    std::error_code ec;
    switch (storage_kind()) {
      case json_storage_kind::short_str:
      case json_storage_kind::long_str: {
        return string_type2(as_string_view().data(), as_string_view().length(),
                            alloc);
      }
      case json_storage_kind::byte_str: {
      ...
      case json_storage_kind::array: {
        ...
        {
          basic_compact_json_encoder<char_type,
                                     jsoncons::string_sink<string_type2>>
              encoder(s);
          dump(encoder);
        }
        return s;
    ...
    switch (storage_kind()) {
      case json_storage_kind::array:
        if (i >= cast<array_storage>().value().size()) {
          JSONCONS_THROW(
              json_runtime_error<std::out_of_range>("Invalid array subscript"));
        }
      ...
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>(
            "Index on non-array value not supported"));
    }
  }
  ...
  T get_value_or(const string_view_type& key, U&& default_value) const {
    ...
    switch (storage_kind()) {
      ...
      case json_storage_kind::const_json_pointer:
        return cast<json_const_pointer_storage>()
            .value()
            ->template get_value_or<T, U>(key, std::forward<U>(default_value));
      default: {
        JSONCONS_THROW(not_an_object(key.data(), key.length()));
      }
    }
    ...
    switch (storage_kind()) {
      ...
      case json_storage_kind::object:
        return object_iterator(
            cast<object_storage>().value().erase(first, last));
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>("Not an object"));
        break;
    }
  ...
  // Removes all elements from an array value whose index is between from_index,
  // inclusive, and to_index, exclusive.
  ...
  std::pair<object_iterator, bool> insert_or_assign(
    ...
    switch (storage_kind()) {
      case json_storage_kind::empty_object: {
        create_object_implicitly();
        auto result = cast<object_storage>().value().insert_or_assign(
  ...
  std::pair<object_iterator, bool> try_emplace(const string_view_type& name,
    ...
    switch (storage_kind()) {
      case json_storage_kind::empty_object: {
        create_object_implicitly();
        auto result = cast<object_storage>().value().try_emplace(
    ...
    switch (source.storage_kind()) {
      ...
      case json_storage_kind::object:
        switch (storage_kind()) {
          case json_storage_kind::empty_object:
            create_object_implicitly();
            cast<object_storage>().value().merge(
                source.cast<object_storage>().value());
            break;
          case json_storage_kind::object:
            cast<object_storage>().value().merge(
                source.cast<object_storage>().value());
          ...
          default:
            JSONCONS_THROW(json_runtime_error<std::domain_error>(
                "Attempting to merge a value that is not an object"));
        }
        break;
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>(
      ...
      case json_storage_kind::object:
        switch (storage_kind()) {
          case json_storage_kind::empty_object:
            create_object_implicitly();
            cast<object_storage>().value().merge(
                std::move(source.cast<object_storage>().value()));
            break;
          case json_storage_kind::object:
            cast<object_storage>().value().merge(
                std::move(source.cast<object_storage>().value()));
      ...
      case json_storage_kind::object:
        switch (storage_kind()) {
          case json_storage_kind::empty_object:
            create_object_implicitly();
            cast<object_storage>().value().merge(
                hint, source.cast<object_storage>().value());
            break;
          case json_storage_kind::object:
            cast<object_storage>().value().merge(
                hint, source.cast<object_storage>().value());
      ...
      case json_storage_kind::object:
        switch (storage_kind()) {
          case json_storage_kind::empty_object:
            create_object_implicitly();
            cast<object_storage>().value().merge(
                hint, std::move(source.cast<object_storage>().value()));
            break;
          case json_storage_kind::object:
            cast<object_storage>().value().merge(
                hint, std::move(source.cast<object_storage>().value()));
    ...
    switch (source.storage_kind()) {
      ...
      case json_storage_kind::object:
        switch (storage_kind()) {
          case json_storage_kind::empty_object:
            create_object_implicitly();
            cast<object_storage>().value().merge_or_update(
                source.cast<object_storage>().value());
            break;
          case json_storage_kind::object:
            cast<object_storage>().value().merge_or_update(
          ...
          default:
            JSONCONS_THROW(json_runtime_error<std::domain_error>(
                "Attempting to merge or update a value that is not an object"));
        }
        break;
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>(
  ...
  object_iterator insert_or_assign(object_iterator hint,
    ...
    switch (storage_kind()) {
      case json_storage_kind::empty_object:
        create_object_implicitly();
        return object_iterator(cast<object_storage>().value().insert_or_assign(
            hint, name, std::forward<T>(val)));
      case json_storage_kind::object:
        return object_iterator(cast<object_storage>().value().insert_or_assign(
            hint, name, std::forward<T>(val)));
      default:
  ...
  object_iterator try_emplace(object_iterator hint,
    ...
    switch (storage_kind()) {
      case json_storage_kind::empty_object:
        create_object_implicitly();
        return object_iterator(cast<object_storage>().value().try_emplace(
            hint, name, std::forward<Args>(args)...));
      case json_storage_kind::object:
        return object_iterator(cast<object_storage>().value().try_emplace(
            hint, name, std::forward<Args>(args)...));
      default:
  ...
  array_iterator insert(const_array_iterator pos, T&& val) {
    switch (storage_kind()) {
      ...
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>(
            "Attempting to insert into a value that is not an array"));
    }
  }
  ...
  void insert(InputIt first, InputIt last) {
    switch (storage_kind()) {
      ...
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>(
            "Attempting to insert into a value that is not an object"));
    }
  }
  ...
  array_iterator emplace(const_array_iterator pos, Args&&... args) {
    switch (storage_kind()) {
      case json_storage_kind::array:
        return cast<array_storage>().value().emplace(
  ...
  basic_json& emplace_back(Args&&... args) {
    switch (storage_kind()) {
      case json_storage_kind::array:
        return cast<array_storage>().value().emplace_back(
            std::forward<Args>(args)...);
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>(
            "Attempting to insert into a value that is not an array"));
  ...
  friend void swap(basic_json& a, basic_json& b) noexcept { a.swap(b); }
  ...
  std::basic_string<char_type> to_string() const noexcept {
    ...
    string_type2 s;
    basic_compact_json_encoder<char_type, jsoncons::string_sink<string_type2>>
        encoder(s);
    dump(encoder);
    return s;
  }
  ...
  object_range_type object_range() {
    switch (storage_kind()) {
      ...
      case json_storage_kind::object:
        return object_range_type(
            object_iterator(cast<object_storage>().value().begin()),
  ...
  const_object_range_type object_range() const {
    switch (storage_kind()) {
      case json_storage_kind::empty_object:
        return const_object_range_type(const_object_iterator(),
                                       const_object_iterator());
      case json_storage_kind::object:
        return const_object_range_type(
            const_object_iterator(cast<object_storage>().value().begin()),
 ...
 private:
  void dump_noflush(basic_json_visitor<char_type>& visitor,
                    std::error_code& ec) const {
    ...
    switch (storage_kind()) {
      ...
      case json_storage_kind::byte_str:
        if (tag() == semantic_tag::ext) {
          visitor.byte_string_value(as_byte_string_view(), ext_tag(), context,
                                    ec);
        } else {
      ...
      case json_storage_kind::half_float:
        ...
        break;
      case json_storage_kind::float64:
        visitor.double_value(cast<double_storage>().value(), tag(), context,
                             ec);
        break;
      case json_storage_kind::int64:
        ...
        break;
      case json_storage_kind::uint64:
        visitor.uint64_value(cast<uint64_storage>().value(), tag(), context,
                             ec);
        break;
      case json_storage_kind::boolean:
      ...
      case json_storage_kind::object: {
        ...
        for (auto it = o.begin(); more && it != o.end(); ++it) {
          visitor.key(string_view_type((it->key()).data(), it->key().length()),
                      context, ec);
      ...
      case json_storage_kind::const_json_pointer:
        return cast<json_const_pointer_storage>().value()->dump_noflush(visitor,
                                                                        ec);
      default:
        break;
    }
  ...
  friend std::basic_ostream<char_type>& operator<<(
      std::basic_ostream<char_type>& os, const basic_json& o) {
    o.dump(os);
    return os;
  }

  friend std::basic_istream<char_type>& operator>>(
      std::basic_istream<char_type>& is, basic_json& o) {
...
template <typename Json>
typename std::enable_if<extension_traits::is_basic_json<Json>::value,
                        bool>::type
...
typename std::enable_if<extension_traits::is_basic_json<Json>::value &&
                            std::is_convertible<T, Json>::value,
                        bool>::type
...
typename std::enable_if<
    is_proxy<Json>::value &&
        std::is_convertible<T, typename Json::proxied_type>::value,
    bool>::type
operator==(const Json& lhs, const T& rhs) {
...
template <typename Json, typename T>
typename std::enable_if<
    is_proxy<Json>::value && !is_proxy<T>::value &&
        !extension_traits::is_basic_json<T>::value &&
        std::is_convertible<T, typename Json::proxied_type>::value,
    bool>::type
operator==(const T& lhs, const Json& rhs) {
...
template <typename Json>
void swap(typename Json::key_value_type& a,
...
using wojson =
    basic_json<wchar_t, order_preserving_policy, std::allocator<char>>;

inline namespace literals {

inline jsoncons::json operator"" _json(const char* s, std::size_t n) {
  return jsoncons::json::parse(jsoncons::json::string_view_type(s, n));
}

inline jsoncons::wjson operator"" _json(const wchar_t* s, std::size_t n) {
  return jsoncons::wjson::parse(jsoncons::wjson::string_view_type(s, n));
}

inline jsoncons::ojson operator"" _ojson(const char* s, std::size_t n) {
  return jsoncons::ojson::parse(jsoncons::ojson::string_view_type(s, n));
}

inline jsoncons::wojson operator"" _ojson(const wchar_t* s, std::size_t n) {
...
using basic_json =
    jsoncons::basic_json<CharT, Policy, std::pmr::polymorphic_allocator<char>>;
