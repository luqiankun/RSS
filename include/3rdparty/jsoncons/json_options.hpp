...
class basic_json_options_common {
 ...
 protected:
  ...
  // basic_json_options_common& operator=(basic_json_options_common&&) =
  // default;
...
class basic_json_encode_options
 ...
 public:
  ...
  line_split_kind object_object_line_splits() const {
    return object_object_line_splits_ == line_split_kind{}
               ? line_splits_
               : object_object_line_splits_;
  }

  line_split_kind array_object_line_splits() const {
    return array_object_line_splits_ == line_split_kind{}
               ? line_splits_
               : array_object_line_splits_;
  }

  line_split_kind object_array_line_splits() const {
    return object_array_line_splits_ == line_split_kind{}
               ? line_splits_
               : object_array_line_splits_;
  }

  line_split_kind array_array_line_splits() const {
    return array_array_line_splits_ == line_split_kind{}
               ? line_splits_
               : array_array_line_splits_;
  }
...
class basic_json_options final : public basic_json_decode_options<CharT>,
 ...
 public:
  ...
  basic_json_options& line_splits(line_split_kind value) {
    this->line_splits_ = value;
    return *this;
  }
