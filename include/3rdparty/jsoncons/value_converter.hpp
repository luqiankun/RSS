...
#include "./detail/write_number.hpp"  // from_integer
...
class value_converter_base {
 public:
  using allocator_type = typename std::conditional<
      extension_traits::has_allocator_type<Into>::value,
      typename Into::allocator_type, std::allocator<char>>::type;
...
class value_converter<
    ...
    typename std::enable_if<
        extension_traits::is_byte_sequence<From>::value &&
        !extension_traits::is_string_or_string_view<From>::value &&
        extension_traits::is_string<Into>::value>::type>
    : value_converter_base<Into> {
 public:
...
class value_converter<
    ...
    typename std::enable_if<
        ...
        extension_traits::is_back_insertable_byte_container<Into>::value>::type>
    : value_converter_base<Into> {
 public:
  using allocator_type = typename value_converter_base<Into>::allocator_type;
...
class value_converter<
    ...
    typename std::enable_if<
        ...
        std::is_same<typename From::value_type,
                     typename Into::value_type>::value>::type>
    : value_converter_base<Into> {
 public:
  using allocator_type = typename value_converter_base<Into>::allocator_type;
...
class value_converter<
    From, Into,
    typename std::enable_if<
        extension_traits::is_char_sequence<From>::value &&
        !extension_traits::is_string_or_string_view<Into>::value &&
        extension_traits::is_back_insertable_byte_container<Into>::value>::type>
    : value_converter_base<Into> {
 public:
...
class value_converter<
 ...
 public:
  ...
  Into convert(From value, semantic_tag, std::error_code&) {
    constexpr const char_type* true_constant =
        JSONCONS_CSTRING_CONSTANT(char_type, "true");
    constexpr const char_type* false_constant =
        JSONCONS_CSTRING_CONSTANT(char_type, "false");
...
class value_converter<null_type, Into, void> : value_converter_base<Into> {
 public:
  ...
  Into convert(semantic_tag, std::error_code&) {
    constexpr const char_type* null_constant =
        JSONCONS_CSTRING_CONSTANT(char_type, "null");
