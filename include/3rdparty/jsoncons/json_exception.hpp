...
#include "./unicode_traits.hpp"  // unicode_traits::convert
 ...
 public:
  ...
  const char* what() const noexcept override {
    if (what_.empty()) {
      ...
      JSONCONS_CATCH(...) { return std::out_of_range::what(); }
    } else {
      return what_.c_str();
    }
  }
 ...
 public:
  ...
  const char* what() const noexcept override {
    if (what_.empty()) {
      ...
      JSONCONS_CATCH(...) { return std::runtime_error::what(); }
    } else {
      return what_.c_str();
    }
  }
