...
template <typename CharT>
struct is_char16<
    CharT, typename std::enable_if<std::is_integral<CharT>::value &&
                                   !std::is_same<CharT, bool>::value &&
                                   (std::is_same<CharT, char16_t>::value ||
                                    sizeof(uint16_t) == sizeof(CharT))>::type>
    : std::true_type {};
...
struct is_char32<
    CharT, typename std::enable_if<std::is_integral<CharT>::value &&
                                   ...
                                   (std::is_same<CharT, char32_t>::value ||
                                    (!std::is_same<CharT, char16_t>::value &&
                                     sizeof(uint32_t) == sizeof(CharT)))>::type>
    : std::true_type {};
...
template <class T>
struct is_int128_type<
    T, typename std::enable_if<std::is_same<T, int128_type>::value>::type>
    : std::true_type {};
#endif
...
#if defined(JSONCONS_HAS_INT128)
template <class T>
struct is_uint128_type<
    T, typename std::enable_if<std::is_same<T, uint128_type>::value>::type>
    : std::true_type {};
#endif
...
class integer_limits<
 ...
 public:
  ...
  static constexpr std::size_t buffer_size =
      static_cast<std::size_t>(sizeof(T) * CHAR_BIT * 0.302) + 3;
...
template <class T>
class integer_limits<T,
                     typename std::enable_if<!std::is_integral<T>::value &&
                                             is_int128_type<T>::value>::type> {
 public:
  static constexpr bool is_specialized = true;
  ...
  static constexpr T(min)() noexcept { return -(max)() - 1; }
...
using is_detected_exact = std::is_same<Expected, is_detected_t<Op, Args...>>;

// is_detected_convertible

template <class To, template <class...> class Op, class... Args>
using is_detected_convertible =
    std::is_convertible<is_detected_t<Op, Args...>, To>;
...
template <class T>
inline T* to_plain_pointer(T* ptr) {
  return (ptr);
}
...
template <class T>
struct is_std_byte<
    T, typename std::enable_if<std::is_same<T, std::byte>::value>::type>
    : std::true_type {};
#endif
// is_byte
...
struct is_byte<
    ...
    typename std::enable_if<
        ...
        std::is_same<T, unsigned char>::value || is_std_byte<T>::value>::type>
    : std::true_type {};
...
struct is_narrow_character<
    T, typename std::enable_if<is_character<T>::value &&
                               (sizeof(T) == sizeof(char))>::type>
    : std::true_type {};
...
template <typename T>
struct is_cstring
    : public ut_detail::is_cstring_impl<typename std::decay<T>::type> {};
...
template <class T>
struct is_bool<T, typename std::enable_if<std::is_same<T, bool>::value>::type>
    : std::true_type {};
...
template <class T>
struct is_u8_u16_u32_or_u64<
    T, typename std::enable_if<std::is_same<T, uint8_t>::value ||
...
template <class T>
struct is_i8_i16_i32_or_i64<
    T, typename std::enable_if<std::is_same<T, int8_t>::value ||
...
struct is_float_or_double<
    T, typename std::enable_if<std::is_same<T, float>::value ||
...
#if defined(JSONCONS_HAS_INT128)
template <>
struct make_unsigned_impl<int128_type> {
  using type = uint128_type;
};
template <>
struct make_unsigned_impl<uint128_type> {
  using type = uint128_type;
};
#endif

template <class T>
struct make_unsigned : make_unsigned_impl<typename std::remove_cv<T>::type> {};
...
template <class T>
struct is_integer<
    T, typename std::enable_if<integer_limits<T>::is_specialized>::type>
    : std::true_type {};
...
struct is_signed_integer<
    T, typename std::enable_if<integer_limits<T>::is_specialized &&
                               integer_limits<T>::is_signed>::type>
    : std::true_type {};
...
template <class T>
struct is_primitive<
    T, typename std::enable_if<is_integer<T>::value || is_bool<T>::value ||
...
using container_npos_t = decltype(Container::npos);

template <class Container>
using container_allocator_type_t = typename Container::allocator_type;

template <class Container>
using container_mapped_type_t = typename Container::mapped_type;

template <class Container>
using container_key_type_t = typename Container::key_type;
...
template <class Container>
using container_char_traits_t = typename Container::traits_type::char_type;

template <class Container>
using container_push_back_t = decltype(std::declval<Container>().push_back(
    std::declval<typename Container::value_type>()));

template <class Container>
using container_push_front_t = decltype(std::declval<Container>().push_front(
    std::declval<typename Container::value_type>()));

template <class Container>
using container_insert_t = decltype(std::declval<Container>().insert(
    std::declval<typename Container::value_type>()));

template <class Container>
using container_reserve_t = decltype(std::declval<Container>().reserve(
    typename Container::size_type()));

template <class Container>
using container_data_t = decltype(std::declval<Container>().data());

template <class Container>
using container_size_t = decltype(std::declval<Container>().size());
...
template <class T>
struct has_allocator_type<T, typename std::enable_if<is_detected<
                                 container_allocator_type_t, T>::value>::type>
    : std::true_type {};
...
struct is_string_or_string_view<
    T, typename std::enable_if<
           ...
           is_detected_exact<typename T::value_type, container_char_traits_t,
                             T>::value &&
           is_detected<container_npos_t, T>::value>::type> : std::true_type {};
...
struct is_string<T,
                 typename std::enable_if<is_string_or_string_view<T>::value &&
                                         has_allocator_type<T>::value>::type>
    : std::true_type {};
...
struct is_string_view<
    T, typename std::enable_if<
           is_string_or_string_view<T>::value &&
           !is_detected<container_allocator_type_t, T>::value>::type>
    : std::true_type {};
...
struct is_map_like<T, typename std::enable_if<
                          is_detected<container_mapped_type_t, T>::value &&
                          is_detected<container_allocator_type_t, T>::value &&
                          is_detected<container_key_type_t, T>::value &&
                          is_detected<container_value_type_t, T>::value>::type>
    : std::true_type {};
...
struct is_list_like<T,
                    typename std::enable_if<
                        ...
                        !is_detected_exact<typename T::value_type,
                                           container_char_traits_t, T>::value &&
                        !is_map_like<T>::value>::type> : std::true_type {};
...
template <class T>
struct is_constructible_from_const_pointer_and_size<
    T, typename std::enable_if<std::is_constructible<
           T, typename T::const_pointer, typename T::size_type>::value>::type>
    : std::true_type {};

// has_reserve

template <class Container>
using has_reserve = is_detected<container_reserve_t, Container>;

// is_back_insertable

template <class Container>
using is_back_insertable = is_detected<container_push_back_t, Container>;

// is_front_insertable

template <class Container>
using is_front_insertable = is_detected<container_push_front_t, Container>;

// is_insertable

template <class Container>
using is_insertable = is_detected<container_insert_t, Container>;

// has_data, has_data_exact

template <class Container>
using has_data = is_detected<container_data_t, Container>;

template <class Ret, class Container>
using has_data_exact = is_detected_exact<Ret, container_data_t, Container>;

// has_size

template <class Container>
using has_size = is_detected<container_size_t, Container>;
...
struct has_data_and_size {
  static constexpr bool value =
      has_data<Container>::value && has_size<Container>::value;
};
...
struct is_byte_sequence<
    Container, typename std::enable_if<
                   has_data_exact<const typename Container::value_type*,
                                  const Container>::value &&
                   has_size<Container>::value &&
                   is_byte<typename Container::value_type>::value>::type>
    : std::true_type {};
...
struct is_char_sequence<
    Container, typename std::enable_if<
                   has_data_exact<const typename Container::value_type*,
                                  const Container>::value &&
                   has_size<Container>::value &&
                   is_character<typename Container::value_type>::value>::type>
    : std::true_type {};
...
struct is_sequence_of<
    ...
    typename std::enable_if<
        has_data_exact<const typename Container::value_type*,
                       const Container>::value &&
        has_size<Container>::value &&
        std::is_same<typename Container::value_type, ValueT>::value>::type>
    : std::true_type {};
...
template <class Container>
struct is_back_insertable_byte_container<
    Container, typename std::enable_if<
...
template <class Container>
struct is_back_insertable_char_container<
    Container, typename std::enable_if<
                   is_back_insertable<Container>::value &&
                   is_character<typename Container::value_type>::value>::type>
    : std::true_type {};
...
template <class Container, class ValueT>
struct is_back_insertable_container_of<
    Container, ValueT,
    typename std::enable_if<
        is_back_insertable<Container>::value &&
        std::is_same<typename Container::value_type, ValueT>::value>::type>
...
struct is_typed_array<
    T, typename std::enable_if<
           is_list_like<T>::value &&
           (std::is_same<typename std::decay<typename T::value_type>::type,
                         uint8_t>::value ||
            std::is_same<typename std::decay<typename T::value_type>::type,
                         uint16_t>::value ||
            std::is_same<typename std::decay<typename T::value_type>::type,
            ...
            std::is_same<typename std::decay<typename T::value_type>::type,
                         float_t>::value ||
            std::is_same<typename std::decay<typename T::value_type>::type,
                         double_t>::value)>::type> : std::true_type {};
...
template <typename T>
using construct_from_string_t = decltype(T(std::string{}));

template <class T>
using is_constructible_from_string = is_detected<construct_from_string_t, T>;

template <typename T, typename Data, typename Size>
using construct_from_data_size_t =
    decltype(T(static_cast<Data>(nullptr), Size{}));

template <class T, typename Data, typename Size>
using is_constructible_from_data_size =
    is_detected<construct_from_data_size_t, T, Data, Size>;

// is_unary_function_object
// is_unary_function_object_exact

template <class FunctionObject, class Arg>
using unary_function_object_t =
    decltype(std::declval<FunctionObject>()(std::declval<Arg>()));

template <class FunctionObject, class Arg>
using is_unary_function_object =
    is_detected<unary_function_object_t, FunctionObject, Arg>;

template <class FunctionObject, class T, class Arg>
using is_unary_function_object_exact =
    is_detected_exact<T, unary_function_object_t, FunctionObject, Arg>;

// is_binary_function_object
// is_binary_function_object_exact

template <class FunctionObject, class Arg1, class Arg2>
using binary_function_object_t = decltype(std::declval<FunctionObject>()(
    std::declval<Arg1>(), std::declval<Arg2>()));

template <class FunctionObject, class Arg1, class Arg2>
using is_binary_function_object =
    is_detected<binary_function_object_t, FunctionObject, Arg1, Arg2>;

template <class FunctionObject, class T, class Arg1, class Arg2>
using is_binary_function_object_exact =
...
struct is_convertible_to_string_view<
    Source, typename std::enable_if<is_string_or_string_view<Source>::value ||
                                    is_cstring<Source>::value>::type>
    : std::true_type {};
...
using allocator_outer_allocator_type_t =
    typename Allocator::outer_allocator_type;

template <class Allocator>
using allocator_inner_allocator_type_t =
    typename Allocator::inner_allocator_type;
...
struct is_polymorphic_allocator<
    T,
    typename std::enable_if<(
        std::is_same<T, std::pmr::polymorphic_allocator<char>>::value)>::type>
    : std::true_type {};
#endif
template <class T>
struct is_propagating_allocator<
    T, typename std::enable_if<
           (is_polymorphic_allocator<T>::value) ||
           (is_detected<allocator_outer_allocator_type_t, T>::value &&
            is_detected<allocator_inner_allocator_type_t, T>::value)>::type>
    : std::true_type {};
